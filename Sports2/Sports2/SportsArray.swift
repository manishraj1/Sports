...
class SportsArray {
    ...
    static var stadiumKeys = ["Arrowhead Stadium", "AT&T Stadium", "Allegiant Stadium", "Bank of America Stadium", "CenturyLink Field", "Edward Jones Dome", "Empower Field at Mile High", "FedEx Field", "FirstEnergy Stadium", "Ford Field", "Gillette Stadium", "Hard Rock Stadium", "Heinz Field", "Lambeau Field", "Levi's Stadium", "Lincoln Financial Field", "Lucas Oil Stadium", "M&T Bank Stadium", "Mercedes-Benz Superdome", "Mercedes-Benz Stadium", "MetLife Stadium", "New Era Field", "Nissan Stadium", "NRG Stadium", "Paul Brown Stadium", "Raymond James Stadium", "RingCentral Coliseum ", "Qualcomm Stadium", "Los Angeles Memorial Coliseum", "SoFi Stadium", "Soldier Field", "TIAA Bank Field", "U.S. Bank Stadium"]
